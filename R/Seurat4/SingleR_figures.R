...
###############################
pred = readRDS("output/MCL_TCR_BCR_20211210_singleR_pred.rds")
object = readRDS("data/MCL_SCT_TCR_BCR_20211210.rds")
...
singlerDF$cell.types %<>% gsub("Astrocytes|Adipocytes|Fibroblasts|mv Endothelial cells|Keratinocytes|Epithelial cells|Mesangial cells","Nonhematopoietic cells",.)
...
saveRDS(object, file = "data/MCL_SCT_TCR_BCR_20211210.rds")
